    ...
    >
      ...
      <div className="flex gap-3 px-3 sm:px-0">
        ...
        <div className="flex flex-col">
          <h3 className="font-semibold text-[16px] leading-tight line-clamp-2 group-hover:text-[#3ea6ff] transition-colors text-foreground">
            {video.title}
          </h3>
          <div className="mt-1 text-sm text-[#aaaaaa] flex flex-col">
            <span className="hover:text-foreground transition-colors">{video.channel.name}</span>
